...
exports('AddButton', function(title, description, type, trigger, par, id)
    if(id == nil) then id = false end
    SetNuiFocus(true , true)
    SendNUIMessage({addbutton = true, title = title, description = description, type = type, trigger = trigger, par = par, id = id })
end)
...
RegisterCommand("example" , function()
    ...
    exports['br-menu']:AddButton("Example Button Title1", "Description", 'client', 'menu:test', 'example button 1', 'me')
    exports['br-menu']:AddButton("Example Button Title2", "Description", 'client', 'menu:test', 'example button 2', "menuone" )
    exports['br-menu']:AddButton("Example Button Title3", "Description", 'client', 'menu:test','example button 3', "me" )
